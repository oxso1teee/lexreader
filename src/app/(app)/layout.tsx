    ...
    <div className="flex min-h-screen flex-1 flex-col bg-background">
      <header className="sticky top-0 z-20 flex items-center justify-between bg-background/95 px-4 py-3 backdrop-blur">
        <Link
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-black/20 text-blue-600 dark:border-white/25"
        >
        ...
        <div className="h-9 w-9 rounded-full border-2 border-black/80 dark:border-white/80" />
      </header>
